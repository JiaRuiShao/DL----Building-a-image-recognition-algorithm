...
```
    ...
    <matplotlib.text.Text at 0x7ff6b016a940>
...
**Interpretation**:
- The larger models (with more hidden units) are able to fit the training set better, until eventually **the largest models overfit the data**. # how to avoid >> regularization
